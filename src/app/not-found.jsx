    ...
    return (
        <div className="flex items-center justify-center max-w-xl min-h-screen mx-auto">
            <div className="flex flex-col items-center justify-center">
                ...
                <Link href='/'>
                    <button className="w-64 py-3 mt-2 text-xl font-semibold rounded-md hover:bg-opacity-90 hover:transition-all bg-color-accent text-color-dark px-7">Kembali</button>
                </Link>
            </div>
        </div>
    )
